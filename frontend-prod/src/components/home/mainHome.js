...
class mainHome extends Component {
  ...
  search = () => {
    ...
    axios.post("https://nightin.xyz/search", query).then(response => {
      if (this.state.searchType !== "random")
        this.setState({
    ...
    this.setState(
      ...
      () => {
        ...
        if (this.props.auth&&this.state.eingre) {
          let that = this;
          axios
            .get("https://nightin.xyz/excludedIngredients", {
  ...
  randomSearch = () => {
    ...
    // Set the results once we get them back from the server
    axios
      .post("https://nightin.xyz/randomsearch", {
        number: 16
      })
      .then(response => {
  ...
  myIngredientsSearch = () => {
    ...
    // Set the results once we get them back from the server
    axios.post("https://nightin.xyz/onhandSearch", {
